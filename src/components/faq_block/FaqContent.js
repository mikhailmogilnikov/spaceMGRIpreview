        ...
        <>
            <div className="element_container">
                ...
                <div className="content_cover">
                    <Accordion title='Что такое Space?' description='Space – это глобальное дополнение к электронно-образовательной платформе stud.mgri.ru. Приложение позволяет упростить и ускорить выполение типичных задач пользователя stud.' />
