	...
	return (
		<nav className='nav_bar_container'>
			<div className='nav_bar'>
				<NavLink
					to='https://stud.mgri.ru/WebApp/#/mail/all'
					target='_blank'
					rel='noreferrer'
			...
			<div className='nav_bar nav_bar_mobile'>
				<NavLink
					to='/schedule'
					className='nav_elem_container nav_bar_mobile_container'
				>
				...
				<NavLink
					to='/courses'
					className='nav_elem_container nav_tablet nav_bar_mobile_container '
				>
